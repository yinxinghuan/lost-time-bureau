...
async function runViewport(browser, viewport, suffix) {
  ...
  await page.close()
  return { suffix, errors, stillReveal, compareVisible, reportVisible, failureVisible, audits: [startAudit, caseAudit, statusAudit, pauseAudit, evidenceAudit, detailAudit, revealAudit, echoAudit, resultAudit] }
}
